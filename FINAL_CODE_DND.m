...
% Detect Objects
  function [centroids, bboxes, mask] = detectObjects(frame)
        ...
        [~, centroids, bboxes] = obj.blobAnalyser.step(mask);  %MODIFY THIS TO [~, ~, bboxes] = step(blob, frame);
